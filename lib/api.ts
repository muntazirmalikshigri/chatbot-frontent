...
//     { method: "DELETE" }
//   ),
//   // api.ts mein add karo — logout se pehle:

// saveWhatsApp: (companyId: string, payload: { phoneNumberId: string; accessToken: string; verifyToken: string }) =>
//   request<Company>(`/companies/${companyId}/whatsapp`, {
//     method: "POST",
//     body: JSON.stringify(payload),
//   }),

// removeWhatsApp: (companyId: string) =>
//   request<null>(`/companies/${companyId}/whatsapp`, {
//     method: "DELETE",
//   }),

// getWhatsAppStatus: (companyId: string) =>
//   request<{ configured: boolean; isActive: boolean; verifiedAt: string | null; phoneNumberId: string | null }>(
//     `/whatsapp/${companyId}/status`
//   ),

//   logout: async () => {
//     try {
//       await request<{ success: boolean }>("/logout", {
//         method:"PUT",
//       });
//     } catch {
